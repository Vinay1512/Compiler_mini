...
fun yyAction35 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (Tokens.STRING(String.extract(yytext,1,SOME ((size yytext) - 2)), yypos, yypos + size yytext))
      end
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction34(strm, yyNO_MATCH)
                      else yyQ44(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction34(strm, yyNO_MATCH)
                  else yyQ44(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction2(strm, yyNO_MATCH)
                      else yyQ44(strm', yyMATCH(strm, yyAction2, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction2(strm, yyNO_MATCH)
                  else yyQ44(strm', yyMATCH(strm, yyAction2, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction34(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction34(strm, yyNO_MATCH)
                  else yyQ58(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ44(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
              else yyAction34(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction4(strm, yyNO_MATCH)
                      else yyQ44(strm', yyMATCH(strm, yyAction4, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction4(strm, yyNO_MATCH)
                  else yyQ44(strm', yyMATCH(strm, yyAction4, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction34(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ72(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
            else if inp < #"t"
              then if inp = #"`"
                  then yyAction34(strm, yyNO_MATCH)
                  else yyQ44(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction5(strm, yyNO_MATCH)
                      else yyQ44(strm', yyMATCH(strm, yyAction5, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction5(strm, yyNO_MATCH)
                  else yyQ44(strm', yyMATCH(strm, yyAction5, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction1(strm, yyNO_MATCH)
                      else yyQ44(strm', yyMATCH(strm, yyAction1, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction1(strm, yyNO_MATCH)
                  else yyQ44(strm', yyMATCH(strm, yyAction1, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction34(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ79(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction34(strm, yyNO_MATCH)
                  else yyQ44(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
       ...
       of NONE => yyAction34(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction34(strm, yyNO_MATCH)
                  else yyQ78(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ44(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
              else yyAction34(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction34(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ77(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
            else if inp < #"h"
              then if inp = #"`"
                  then yyAction34(strm, yyNO_MATCH)
                  else yyQ44(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction3(strm, yyNO_MATCH)
                      else yyQ44(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction3(strm, yyNO_MATCH)
                  else yyQ44(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ44(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
       ...
       of NONE => yyAction34(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ83(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
            else if inp < #"k"
              then if inp = #"`"
                  then yyAction34(strm, yyNO_MATCH)
                  else yyQ44(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
       ...
       of NONE => yyAction34(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction34(strm, yyNO_MATCH)
                  else yyQ82(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ44(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
              else yyAction34(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction34(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ81(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction34(strm, yyNO_MATCH)
                  else yyQ44(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
       ...
       of NONE => yyAction34(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ80(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction34(strm, yyNO_MATCH)
                  else yyQ44(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
...
fun yyQ26 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction15(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ84(strm', yyMATCH(strm, yyAction15, yyNO_MATCH))
...
fun yyQ24 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction17(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ86(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
       ...
       of NONE => yyAction42(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\""
              ...
              else yyQ90(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
      (* end case *))
       ...
       of NONE => yyAction40(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\n"
              ...
              then if inp = #"\t"
                  then yyQ7(strm', yyMATCH(strm, yyAction40, yyNO_MATCH))
